...
Implemented with the log-adapter milestone. The model_inference_cascade test
is the canary for the most common implementation bug (forgetting the
inference_id join leaves raw provider request/response bodies in ClickHouse
forever).
"""
...
@pytest.mark.skip(reason="TensorZeroLogAdapter stub — log-adapter milestone")
